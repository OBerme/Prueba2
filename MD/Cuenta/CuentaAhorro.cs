...
namespace MD
{
    public class CuentaAhorro: Cuenta
    {
        ...
        /// POST: crea una cuenta ahorro cuyo iban es IBAN, cuyo saldo es saldo, cuya fecha de apertura es fechaApertura y cuya colección de titulares es titulares
        /// </summary>
        /// <param name="iban"></param>
        /// <param name="saldo"></param>
        /// <param name="fechaApertura"></param>
        /// <param name="titulares"></param>
        public CuentaAhorro(String iban, double saldo, DateTime fechaApertura, ColeccionTitulares titulares):base(iban,saldo,fechaApertura,titulares) 
        {
        ...
        /// <summary>
        /// PRE: ----
        /// POST: devuelve una cadena de caracteres con el iban, el saldo, la fecha de apertura y la colección de titulares de la cuenta ahorro
        /// </summary>
        /// <returns></returns>
