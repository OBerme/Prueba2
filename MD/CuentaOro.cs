...
namespace MD
{
    public class CuentaOro:Cuenta
    {
        ...
        public CuentaOro(String iban, double saldo, DateTime fechaApertura, ColeccionTitulares titulares) : base(iban, saldo, fechaApertura, titulares)
        {
        ...
        /// <summary>
        /// PRE: ----
        /// POST: devuelve una cadena de caracteres con el iban, el saldo, la fecha de apertura y la colección de titulares de la cuenta oro
        /// </summary>
        /// <returns></returns>
